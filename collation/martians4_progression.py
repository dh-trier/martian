...
def main(analysisfile, levdistsfile, progressionplot):
    print("-- Running martians4_progression")
    data = prepare_data(analysisfile, levdistsfile)
    using_pygal(data, progressionplot)

if __name__ == "__main__":
    main(analysisfile, levdistsfile, progressionplot)
